			...
			<ul id="nav">
				...
				<cite>图书管理</cite> <i
					...
					<ul class="sub-menu">
						...
						<li><a _href="roleController/toDepart.do"> <i class="iconfont">&#xe6a7;</i> <cite>修改图书</cite>
						</a></li>
						<li><a _href="roleController/toDepart.do"> <i class="iconfont">&#xe6a7;</i> <cite>查询图书</cite>
						</a></li>
					</ul></li>
				</shiro:hasRole>
				<!-- 示例结束 -->
